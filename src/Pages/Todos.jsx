              ...
              <div className="col-6 text-right">
                <span>
                  <input
                    type="button"
                    value="All"
                    className="btn rounded-pill shadow-lg mx-2 border-light mytodosapps-bg-grey mytodosapps-light mytodosapps-input"
                  />
                </span>
                <span>
                  <input
                ...
                <span>
                  <input
                    type="button"
                    value="Finish"
                    className="btn rounded-pill shadow-lg border-light mytodosapps-bg-grey mytodosapps-light mytodosapps-input"
                  />
                </span>
              </div>
            </div>
                    ...
                    <div className="row">
                      <div className="col-4">
                        <h1 className="font-weight-light">
                          2022/04/03
                          <span className="mytodosapps-font-size-20"> /</span>
                        </h1>
                      </div>
                          ...
                          {value.status_id === 1 ? (
                            <div className="py-3">
                              <input
                                type="button"
                                value="Delete"
                                className="btn shadow-lg py-1 mr-1 mytodosapps-bg-danger mytodosapps-font-size-12 mytodosapps-light mytodosapps-input"
                              />
                              <input
                                type="button"
                                value="Done"
                                className="btn shadow-lg py-1 mr-1 mytodosapps-bg-secondary mytodosapps-font-size-12 mytodosapps-light mytodosapps-input"
                              />
                            </div>
                          ) : null}
                        </div>
              ...
              <div className="container">
                <div className="row align-items-center h-100 px-0 py-0">
                  <div className="col-12 col-md-6 px-5 px-md-0">
                    <h1 className="font-weight-bold mytodosapps-font-size-60">
                      Hi,
                    </h1>
                    <h1 className="font-weight-light mytodosapps-font-size-60">
                      Welcome To Our
                    </h1>
                    <h1 className="font-weight-light mytodosapps-font-size-60">
                      Family!
